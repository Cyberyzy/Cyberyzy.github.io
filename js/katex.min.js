    ...
    function (t, e, r) {
        ...
        u = (function () {
          function t(t) {
            (this.displayMode = void 0),
              ...
              (this.allowedProtocols = c.deflt(t.allowedProtocols, ['http', 'https', 'mailto', '_relative']));
          }
          var e = t.prototype;
          return (
              ...
              return (
                ...
                (!0 === n ||
                  ...
                  ('warn' === n
                    ? ('undefined' != typeof console &&
                        console.warn(
                          "LaTeX-incompatible input and strict mode is set to 'warn': " + e + ' [' + t + ']'
                        ),
                      !1)
                    : ('undefined' != typeof console &&
                        console.warn(
        ...
        L = (function () {
          ...
          return (
            (e.toNode = function () {
              ...
              return (
                this.alternate ? t.setAttribute('d', this.alternate) : t.setAttribute('d', M.path[this.pathName]), t
              );
            }),
            (e.toMarkup = function () {
      ...
      var kt = wt,
        ...
        Bt = function (t, e, r, n, a) {
          ...
          if (((t = o.value), s)) {
            ...
            'undefined' != typeof console && console.warn("No character metrics for '" + t + "' in style '" + e + "'"),
            ...
            for (
              var r = (function (t) {
                  if ('individualShift' === t.positionType) {
                    for (
                      var e = t.children, r = [e[0]], n = -e[0].shift - e[0].elem.depth, a = n, i = 1;
                      i < e.length;
                      i++
                    ) {
        ...
        if (!r)
          throw new Error(
            'Expected node of type "atom" and family "' +
              e +
              '", but got ' +
              (t ? ('atom' === t.type ? 'atom of family ' + t.family : 'node of type ' + t.type) : String(t))
          );
        return r;
      }
      function Vt(t) {
      ...
      function ce(t, e) {
        ...
        for (var n, a = ae(t, e, !0), i = [], o = [], s = 0; s < a.length; s++)
          if ((o.push(a[s]), a[s].hasClass('mbin') || a[s].hasClass('mrel') || a[s].hasClass('allowbreak'))) {
            for (var h = !1; s < a.length - 1 && a[s + 1].hasClass('mspace') && !a[s + 1].hasClass('newline'); )
              ...
              (l = Dt.makeVList(
                {
                  ...
                  children: [
                    { type: 'elem', elem: o },
                    {
                      ...
                      wrapperStyle:
                        s > 0 ? { width: 'calc(100% - ' + 2 * s + 'em)', marginLeft: 2 * s + 'em' } : void 0,
                    },
                  ],
                },
                e
        ...
        Zt({
          ...
          htmlBuilder: function (t, e) {
            ...
            i.classes.push('x-arrow-pad'),
              t.below &&
                ((a = e.havingStyle(n.sub())), (r = Dt.wrapFragment(le(t.below, a, e), e)).classes.push('x-arrow-pad'));
            var o,
              s = Ne(t, e),
            ...
            return (
              o.children[0].children[0].children[1].classes.push('svg-align'), Dt.makeSpan(['mrel', 'x-arrow'], [o], e)
            );
          },
          mathmlBuilder: function (t, e) {
            var r,
      ...
      Zt({
        ...
        Zt({
          ...
          mathmlBuilder: function (t, e) {
            ...
            return (
              t.newLine &&
                (r.setAttribute('linebreak', 'newline'), t.size && r.setAttribute('height', Mt(t.size, e) + 'em')),
              r
            );
          },
        });
      var Le = function (t, e, r) {
        ...
        Fe = function (t, e, r) {
          ...
          return (
            ...
            { type: 'elem', elem: Dt.makeSpan(['delimsizinginner', n], [Dt.makeSpan([], [Dt.makeSymbol(t, e, r)])]) }
          );
        },
      ...
      Zt({
        ...
        Zt({
          ...
          htmlBuilder: function (t, e) {
            or(t);
            for (var r, n, a = ae(t.body, e, !0, ['mopen', 'mclose']), i = 0, o = 0, s = !1, h = 0; h < a.length; h++)
      ...
      var sr = function (t, e) {
          ...
          if ('sout' === i)
            ...
            (l = /box/.test(i) ? ('colorbox' === i ? 0.3 : 0.34) : h ? 0.2 : 0),
              ...
              (s = a.depth + l),
              t.backgroundColor &&
                ((r.style.backgroundColor = t.backgroundColor), t.borderColor && (r.style.borderColor = t.borderColor));
          }
          return (
            (n = t.backgroundColor
              ? Dt.makeVList(
            ...
            /cancel/.test(i) && !h ? Dt.makeSpan(['mord', 'cancel-lap'], [n], e) : Dt.makeSpan(['mord'], [n], e)
          );
        },
        hr = function (t, e) {
      ...
      function mr(t) {
        for (
          var e = t.type,
            ...
            i = t.htmlBuilder,
            o = t.mathmlBuilder,
            s = { type: e, numArgs: n.numArgs || 0, greediness: 1, allowedInText: !1, numOptionalArgs: 0, handler: a },
            h = 0;
          h < r.length;
          ++h
        )
      ...
      var pr = function (t, e) {
          ...
          for (n = 0, B = 0; n < s || B < N.length; ++n, ++B) {
            for (var E = N[B] || {}, O = !0; 'separator' === E.type; ) {
              if (
                (O ||
                  (((A = Dt.makeSpan(['arraycolsep'], [])).style.width = e.fontMetrics().doubleRuleSep + 'em'),
                  q.push(A)),
                '|' === E.separator)
              ) {
      ...
      var Mr = function (t, e) {
          ...
          if (
            ...
            r.size === w.DISPLAY.size
              ...
              : (m > 0 ? ((u = e.fontMetrics().num2), (d = c)) : ((u = e.fontMetrics().num3), (d = 3 * c)),
          ...
          return (
            ...
            (x = null == t.leftDelim ? he(e, ['mopen']) : er(t.leftDelim, g, !0, e.havingStyle(r), t.mode, ['mopen'])),
            (v = t.continued
              ? Dt.makeSpan([])
              : null == t.rightDelim
              ? he(e, ['mclose'])
      ...
      Zt({
        ...
        Zt({
          ...
          htmlBuilder: function (t, e) {
            ...
            return (
              ...
              (a = Dt.makeVList({ positionType: 'firstBaseline', children: [{ type: 'elem', elem: a }] }, e)),
        ...
        Zt({
          ...
          handler: function (t, e) {
            ...
            return (
              n.expect(i, !1), n.switchMode(a), n.consume(), { type: 'styling', mode: n.mode, style: 'text', body: o }
            );
          },
        }),
        Zt({
      ...
      var qr = function (t, e) {
          ...
          if ((h.size === w.DISPLAY.size && a.symbol && !c.contains(['\\smallint'], a.name) && (l = !0), a.symbol)) {
            ...
            if (
              ...
              (s = Dt.makeSymbol(a.name, m, 'math', e, ['mop', 'op-symbol', l ? 'large-op' : 'small-op'])),
              u.length > 0)
            ) {
              var d = s.italic,
        ...
        Er = function (t, e) {
          ...
          if (t.symbol) r = new de('mo', [ge(t.name, t.mode)]);
            ...
            if (!t.body)
              return ue([(r = new de('mi', [new pe(t.name.slice(1))])), new de('mo', [ge('\u2061', 'text')])]);
      ...
      function Rr(t, e, r) {
        for (var n = ae(t, e, !1), a = e.sizeMultiplier / r.sizeMultiplier, i = 0; i < n.length; i++) {
          ...
          o < 0
            ...
            : n[i].classes[o + 1] === 'reset-size' + e.size && (n[i].classes[o + 1] = 'reset-size' + r.size),
            (n[i].height *= a),
            (n[i].depth *= a);
        }
        return Dt.makeFragment(n);
      ...
      Zt({
        ...
        Zt({
          ...
          htmlBuilder: function (t, e) {
            ...
            return (
              (r = Dt.makeVList({ positionType: 'firstBaseline', children: [{ type: 'elem', elem: r }] }, e)),
      ...
      en('\\dotso', function (t) {
        ...
        en('\\mod', '\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern12mu}{\\mkern12mu}{\\mkern12mu}{\\rm mod}\\,\\,#1'),
        en(
          '\\pmb',
      ...
      en(
        ...
        en(
          '\\KaTeX',
          '\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{' + hn + '}{\\scriptsize A}\\kern-.15em\\TeX}{KaTeX}}'
        ),
          ...
          return (
            ...
            (e.handleInfixNodes = function (t) {
              ...
              if (-1 !== r && e) {
                ...
                return (
                  (i =
                    1 === h.length && 'ordgroup' === h[0].type ? h[0] : { type: 'ordgroup', mode: this.mode, body: h }),
                  (s =
            ...
            (e.formLigatures = function (t) {
              for (var e = t.length - 1, r = 0; r < e; ++r) {
                ...
                '-' === i &&
                  '-' === t[r + 1].text &&
                  (r + 1 < e && '-' === t[r + 2].text
                    ? (t.splice(r, 3, { type: 'textord', mode: 'text', loc: n.range(a, t[r + 2]), text: '---' }),
                      (e -= 2))
                    : (t.splice(r, 2, { type: 'textord', mode: 'text', loc: n.range(a, t[r + 1]), text: '--' }),
                      (e -= 1))),
                  ("'" !== i && '`' !== i) ||
                    t[r + 1].text !== i ||
                    (t.splice(r, 2, { type: 'textord', mode: 'text', loc: n.range(a, t[r + 1]), text: i + i }),
                    (e -= 1));
              }
            }),
            (e.parseSymbol = function () {
              ...
              var i,
                s = $r.exec(e);
              if (
                (s && ('i' === (e = e.substring(0, s.index)) ? (e = '\u0131') : 'j' === e && (e = '\u0237')),
                _[this.mode][e])
              ) {
                this.settings.strict &&
                  'math' === this.mode &&
